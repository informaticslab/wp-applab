...
cp ~/informaticslab/wp-applab/wp-content/plugins/app-release/mobile_apps_wordpress.php $dest/wordpress/wp-content/plugins/app-release
cp ~/informaticslab/wp-applab/wp-content/plugins/app-release/gen_manifests.php $dest/wordpress/wp-content/plugins/app-release
