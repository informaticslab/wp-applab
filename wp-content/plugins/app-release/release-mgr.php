...
class ReleaseManager
{
    ...
    function __construct()
    {
        $this->project_templates = [
            ...
            self::$lydia_ios => new ProjectTemplate(self::$lydia_ios, self::$ios_platform_id,'STD Tx Guide 2015', 'StdTxGuide.ipa', 'gov.cdc.oid.nchhstp.StdTxGuide', 'images/std1_icon.png', 'https://github.com/informaticslab/lydia-ios', null),
