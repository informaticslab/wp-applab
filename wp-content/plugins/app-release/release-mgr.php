...
class IosApp extends BaseApp {
    ...
    public function write_manifest($app_title) {
        ...
        fwrite($manifest_file,  '              <key>url</key>'."\n");
        fwrite($manifest_file,  '              <string>http://'.SERVER.$this->ios_dir."/image.57x57.png</string>\n");
        fwrite($manifest_file,  '            </dict>'."\n");
        fwrite($manifest_file,  '            <dict>'."\n");
        fwrite($manifest_file,  '              <key>kind</key>'."\n");
        fwrite($manifest_file,  '              <string>full-size-image</string>'."\n");
        fwrite($manifest_file,  '              <key>url</key>'."\n");
        fwrite($manifest_file,  '              <string>http://'.SERVER.$this->ios_dir."/image.512x512.png<</string>\n");
        fwrite($manifest_file,  '            </dict>'."\n");
        fwrite($manifest_file,  '          </array>'."\n");
