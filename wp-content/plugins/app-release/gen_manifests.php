...
$ios_releases = array (
    ...
    $release_mgr->configure_release(ReleaseManager::$epi, '2.1'),
    $release_mgr->configure_release(ReleaseManager::$lydia_ios, '2.3.1.2'),
    ...
    $release_mgr->configure_release(ReleaseManager::$photon, '1.5.3.1'),
