...
$ios_releases = array (
    ...
    $release_mgr->configure_release(ReleaseManager::$lydia_ios, '2.1.0.1'),
    ...
    $release_mgr->configure_release(ReleaseManager::$lifeguard, '0.3.1.1'),
    $release_mgr->configure_release(ReleaseManager::$photon, '1.1.0.1')
);
